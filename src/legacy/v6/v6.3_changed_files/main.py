...
def query(payload: QueryRequest):
    ...
    if confidence == "none":
        ...
        if is_followup:
            answer = (
                "I'm not finding anything in the knowledge base that matches that "
                "follow-up specifically — could you tell me more concretely what "
                "you'd like me to check or expand on?"
            )
            role_out = "clarify"
        ...
        return {
            ...
            "model": "none",
            "role": role_out,
            "needs_clarification": is_followup,
            "reason": reason,
