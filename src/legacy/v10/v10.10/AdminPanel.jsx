        ...
        {tab === "faq" && (
          <>
            ...
            {faqSource && faqItems.length === 0 && (
              <p className="hint">No FAQ questions stored for this document. If it was ingested before FAQ
                generation — or with no working provider — re-ingest it via the Documents tab
                (provider = DeepSeek or Local) to generate questions.</p>
            )}
            {faqItems.map((it) => (
