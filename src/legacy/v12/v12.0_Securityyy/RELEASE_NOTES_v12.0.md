...
> Internal version v12.0. Previous release was v11.3.3, shipped
> publicly as vGO2.0.
...
- **First attempt** — lexical Jaccard at 0.6 only fired on near-verbatim repeats,
  so the FAQ was effectively dead.
- **Second attempt** — bi-encoder cosine plus a cross-encoder "verifier" served
