        ...
        res = requests.post(
            ...
            json={
                ...
                "options": {
                    ...
                    #   num_ctx: cap the context window — our prompt is small
                    #     (top-3 chunks, 250 chars each), so a big default
                    #     window just wastes setup time.
                    "num_thread": os.cpu_count() or 4,
                    "num_ctx": 2048,
                    "stop": ["\n\nQuestion:", "\n\nContext:", "<context>"],
                },
                # Longer keep_alive so the model stays resident between
                # queries and we don't pay cold-load time repeatedly.
